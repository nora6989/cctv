...
crime_anal_police = pd.read_csv('./crime_in_Seoul_include_gu_name.csv', thousands=',', sep =',',  encoding='utf-8')
...
crime_anal_raw = pd.read_csv('./crime_in_Seoul_include_gu_name.csv',sep=',', encoding='utf-8')
