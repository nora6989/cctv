...
cctv.head()  #최상단의 5개의 로우만 출력 
cctv_meta = cctv.columns 
cctv_meta 

""""""
Index(['기관명', '소계', '2013년도 이전', '2014년', '2015년', '2016년'], dtype='object')
# 기관명, 소계 등 각각의 값은 feature 
""""""
...
pop.sort_values(by='외국인비율', ascending=True)
pop.sort_values(by='고령자비율', ascending=True)
